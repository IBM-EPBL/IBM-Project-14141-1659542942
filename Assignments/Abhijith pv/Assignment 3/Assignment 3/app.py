...
COS_API_KEY_ID = "IwDDEvJXvg1V55GNlS1bDJ0_7R6Z2WQW8OVMes5uSGyQ"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/6eab02d252a3423195c4e0b3c3a40646:dc1a9571-a826-4ec3-9003-2fa0a4eac660::"
...
@app.route('/')
def index():
    files = get_bucket_contents('holabi')
